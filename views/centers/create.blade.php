                        ...
                        <div class="reg-part">
                            ...
                            <div class="form-group-lg row">
                              ...
                              <!--
                                         ...
                                         <div class="form-group-lg row">
                                <div class="form-group clearfix ">
                                    <label class="col-xs-12 col-md-2">الفروع<span
                                                class="text-danger">*</span></label>
                                    <div class="col-xs-12 col-md-10 new-f-group">
                                        <div class="form-group clearfix">
...
@push('scripts')
    ...
    {
            jQuery('select[name="sector_id"]').on('change',function(){
               var sectorID = jQuery(this).val();
               if(sectorID)
               {
                  jQuery.ajax({

                     url : '/dropdownlist/getservice/' +sectorID,
                     type : "GET",
                     dataType : "json",
