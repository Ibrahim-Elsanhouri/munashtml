                    ...
                    @foreach($chances as $chance)
                        ...
                        <div class="card foras">
                            ...
                            <div class="card-date clearfix">
                                ...
                                @if($chance->remaining_days(date('d-m-Y', strtotime( $chance->close_date)))<100)
                                         <div class="progress">
                                    ...
                                    @else
                                        ...
                                        <p><i class="fa fa-calendar"></i>
                                            <span class="text-grey">{{ $chance->hijri(date('d-m-Y', strtotime( $chance->close_date)))->format('d-m-Y') }}</span>
                                            <small class="center" style="display: block"> {{ $chance->close_date }}
 </small>
                                ...
                                <div class="item one_thrd">
                                    ...
                                    <p><i class="fa fa-calendar"></i> <span
                                                class="text-grey">
                                                {{ $chance->hijri(date('d-m-Y', strtotime( $chance->close_date)))->format('d-m-Y') }}
                                        <small class="center"
                                               style="display: block">{{ $chance->close_date }}</small>
                                    </p>
                                </div>
                                <div class="item one_thrd">
                           ...
                           {{ $chance->hijri(date('d-m-Y', strtotime( $chance->created_at)))->format('d-m-Y') }}

                                        </span>
                                        <small class="center"
                                               style="display: block"> {{ $chance->created_at }}</small>
                                    </p>
                                </div>
                            </div>
